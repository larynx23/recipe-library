<template>
  ...
  <form class="max-w-2xl mx-auto" @submit.prevent="submitRecipe">
    <div class="space-y-6">
      <div>
      ...
      <div v-if="recipe.imagePreview" class="mt-2">
        <img :src="recipe.imagePreview" alt="Recept kép" class="w-32 h-32 object-cover">
      </div>
    </div>
