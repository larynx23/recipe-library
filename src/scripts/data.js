...
ingredients: []string - Hozzávalók lista
...
const receiptData = JSON.parse(`{
  "klasszikus_madartej": {
    ...
    "times": [300, 360],
    "ingredients": ["4 db tojásfehérje","1 csipet só","2 ek porcukor","800 ml tej","1 db vanília","4 db tojássárgája","70 g cukor","1 csipet só"],
    "steps": [
